...
/***/ "./src/js/modules/animateSectionBg.js":
/*!********************************************!*\
  !*** ./src/js/modules/animateSectionBg.js ***!
  \********************************************/
...
const animateSectionBg = function (selector) {
  let cfg = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(selector, { ...cfg,
    scrollTrigger: {
      trigger: selector,
      scrub: cfg.scrub,
      start: 'top center',
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (animateSectionBg);

/***/ }),

/***/ "./src/js/modules/animateStuff.js":
/*!****************************************!*\
  !*** ./src/js/modules/animateStuff.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _animateSectionBg__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./animateSectionBg */ "./src/js/modules/animateSectionBg.js");
/* harmony import */ var _invertSection__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./invertSection */ "./src/js/modules/invertSection.js");




const animateStuff = () => {
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to('.cart__gallery', {
    left: '-5%',
    scrollTrigger: {
      trigger: '.cart',
      scrub: 1,
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to('.frequently__item img', {
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.to(initialValue, {
    duration: 2,
    value: 80,
    scrollTrigger: {
      trigger: '.store',
  ...
  gsap__WEBPACK_IMPORTED_MODULE_2__.gsap.from('.deals__stars li', {
    opacity: 0,
    scale: 1.4,
    rotation: 45,
    stagger: 0.1,
  ...
  (0,_invertSection__WEBPACK_IMPORTED_MODULE_1__["default"])('.customer', {
    targets: '.arrow__img, .customer__star',
    className: 'inverted'
  });
  (0,_animateSectionBg__WEBPACK_IMPORTED_MODULE_0__["default"])('.pure__bg', {
    duration: 2,
    scale: 1.1,
    ease: 'slow(0.7, 0.7, false)'
  });
  (0,_animateSectionBg__WEBPACK_IMPORTED_MODULE_0__["default"])('.need__bg', {
    duration: 2,
    scale: 1.2,
    ease: 'slow(0.7, 0.7, false)'
  });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (animateStuff);
...
/***/ "./src/js/modules/fakeHandleSubmit.js":
/*!********************************************!*\
  !*** ./src/js/modules/fakeHandleSubmit.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const fakeHandleSubmit = () => {
  ...
  function animateBtn() {
    gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.fromTo(textBtn, {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (fakeHandleSubmit);

/***/ }),

/***/ "./src/js/modules/invertSection.js":
/*!*****************************************!*\
  !*** ./src/js/modules/invertSection.js ***!
  \*****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
const invertSection = (sectionSelector, toggleClassSettings) => {
  gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to('html', {
    "--main-color": "#000000",
    "--sub-color": "#ffffff",
    scrollTrigger: {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (invertSection);

/***/ }),

/***/ "./src/js/modules/scrollToElements.js":
/*!********************************************!*\
  !*** ./src/js/modules/scrollToElements.js ***!
  \********************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var gsap_CSSRulePlugin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/CSSRulePlugin.js */ "./node_modules/gsap/CSSRulePlugin.js");
/* harmony import */ var _toggleMenu__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./toggleMenu */ "./src/js/modules/toggleMenu.js");
...
const scrollToElements = () => {
  ...
  const rule = gsap_CSSRulePlugin_js__WEBPACK_IMPORTED_MODULE_1__.CSSRulePlugin.getRule('.nav__menu:after');
  ...
  function scrollToElementByAttribute(btn) {
    const scrollToElement = document.querySelector(btn.getAttribute('data-scrollTo'));
    const offset = btn.classList.contains('arrow') ? 0 : scrollToElement.offsetTop;
    btn.addEventListener('click', e => {
      e.preventDefault();

      if (btn.hasAttribute('data-mobile')) {
        const customTimeLine = (0,_toggleMenu__WEBPACK_IMPORTED_MODULE_0__.closeMenu)(rule);
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (scrollToElements);

/***/ }),

/***/ "./src/js/modules/setPreloader.js":
/*!****************************************!*\
  !*** ./src/js/modules/setPreloader.js ***!
  \****************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
/* harmony import */ var _smoothScroll__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./smoothScroll */ "./src/js/modules/smoothScroll.js");
...
const setPreloader = () => {
  ...
  function activePreloader() {
    ...
    tl.to('.p', {
      ...
      onComplete: () => {
        setOverflow();
        (0,_smoothScroll__WEBPACK_IMPORTED_MODULE_0__["default"])('smooth-scroll-wrapper');
      }
    }).to('.cursor', {
      opacity: 1
    });
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (setPreloader);
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const smoothScroll = function (wrapperSelector) {
  let speed = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.04;
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   "toggleMenuState": () => (/* binding */ toggleMenuState)
/* harmony export */ });
/* harmony import */ var gsap__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! gsap */ "./node_modules/gsap/index.js");
/* harmony import */ var gsap_CSSRulePlugin_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! gsap/CSSRulePlugin.js */ "./node_modules/gsap/CSSRulePlugin.js");


function closeMenu(rule) {
...
function toggleMenuState(menuClass) {
...
const toggleMenu = () => {
  const openBtn = document.querySelector('.nav__menu'),
        ...
        rule = gsap_CSSRulePlugin_js__WEBPACK_IMPORTED_MODULE_1__.CSSRulePlugin.getRule(".nav__menu:after");
...
/* harmony import */ var gsap_CSSRulePlugin_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! gsap/CSSRulePlugin.js */ "./node_modules/gsap/CSSRulePlugin.js");
/* harmony import */ var gsap_ScrollToPlugin_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! gsap/ScrollToPlugin.js */ "./node_modules/gsap/ScrollToPlugin.js");
...
/* harmony import */ var gsap_Flip__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! gsap/Flip */ "./node_modules/gsap/Flip.js");
/* harmony import */ var _modules_setPreloader__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/setPreloader */ "./src/js/modules/setPreloader.js");
...
/* harmony import */ var _modules_customCursor__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./modules/customCursor */ "./src/js/modules/customCursor.js");
/* harmony import */ var _modules_scrollToElements__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./modules/scrollToElements */ "./src/js/modules/scrollToElements.js");
/* harmony import */ var _modules_animateStuff__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./modules/animateStuff */ "./src/js/modules/animateStuff.js");
/* harmony import */ var _modules_fakeHandleSubmit__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/fakeHandleSubmit */ "./src/js/modules/fakeHandleSubmit.js");
...
gsap__WEBPACK_IMPORTED_MODULE_6__.gsap.registerPlugin(gsap_ScrollToPlugin_js__WEBPACK_IMPORTED_MODULE_7__.ScrollToPlugin, gsap_CSSRulePlugin_js__WEBPACK_IMPORTED_MODULE_8__.CSSRulePlugin, gsap_Flip__WEBPACK_IMPORTED_MODULE_9__.Flip, gsap_ScrollTrigger__WEBPACK_IMPORTED_MODULE_10__.ScrollTrigger);
window.paceOptions = {
  ajax: true,
  document: true,
  eventLag: false
...
window.addEventListener('DOMContentLoaded', () => {
  ...
  (0,_modules_setPreloader__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_modules_scrollToElements__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_modules_customCursor__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_modules_animateStuff__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_modules_fakeHandleSubmit__WEBPACK_IMPORTED_MODULE_5__["default"])();
});
})();
